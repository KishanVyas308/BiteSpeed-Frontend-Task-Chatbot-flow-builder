 ...
 * - WhatsApp logo in top-right corner
...
const TextNode = memo(({ data, selected }: NodeProps<TextNodeData>) => {
  return (
    <div className={`
      relative bg-white border-2 rounded-lg w-52 shadow-md transition-all duration-200
    ...
    `}>
      ...
      <div className="flex items-center p-2 bg-green-50 border-b border-gray-100 rounded-t-lg">
        <div className="text-sm mr-2">💬</div>
        <div className="text-xs font-medium text-gray-700">Send Message</div>
      </div>
      
      <div className="p-3 text-sm text-gray-800 min-h-[40px] leading-relaxed">
